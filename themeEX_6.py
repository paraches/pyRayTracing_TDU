...
from GeometryUtils.Fog import Fog
...
def theme_ex_6():
    ...
    fog = Fog(fog_color=FColor(100.0/255.0, 149.0/255.0, 237.0/255.0))
    scene = Scene(shapes, lights, i_ambient, GLOBAL_REFRACTION_INDEX, camera, width, height, True, fog)
