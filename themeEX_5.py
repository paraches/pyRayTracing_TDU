...
from GeometryUtils.Shapes.Cylinder import Cylinder
...
def theme_ex_5():
    ...
    shapes = [
        ...
        Cylinder(PVector(0, 0, 10), 1, 2, Material(FColor(0.01), FColor(0, 0.69, 0.69), FColor(0.30), 8.0)),
        Cylinder(PVector(-1, 0, 5), 1, 2, Material(FColor(0.01), FColor(0.69, 0, 0.69), FColor(0.30), 8.0)),
